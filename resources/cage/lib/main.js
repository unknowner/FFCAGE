...
var pageModCastleAge = require("page-mod").PageMod({
	...
	contentScriptFile : [
		...
		data.url("js/ca/base/language.js"),
		data.url("js/ca/base/tool.js"),
		data.url("js/ca/base/sidebar.js"),
		data.url("js/ca/base/utilities.js"),
		data.url("js/ca/base/ca_receiver.js"),
		data.url("js/ca/base/functions.js"),
		data.url("js/ca/base/settings.js"),
